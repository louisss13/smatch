...
namespace smartch.Controllers
{
    ...
    public class JwtController : Controller
    {
        ...
        public JwtController(IOptions<JwtIssuerOptions> jwtOptions, ILoggerFactory loggerFactory, SignInManager<Account> signInManager, UserManager<Account> userManager)
        {
